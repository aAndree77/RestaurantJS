  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(result.error || "Eroare la crearea produsului")
      }
    } catch (error) {
      console.error("Error:", error)
      setError("Eroare la crearea produsului")
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-slate-800 rounded-2xl border border-slate-700 p-6 lg:p-8">
        <h1 className="text-2xl font-bold text-white mb-6">Produs nou</h1>
            ...
            >
              {imagePreview ? (
                ...
                <div className="h-48 flex flex-col items-center justify-center">
                  ...
                  <p className="text-slate-500 text-xs mt-1">PNG, JPG sau WebP (max 5MB)</p>
                </div>
              )}
              <input
                ref={fileInputRef}
